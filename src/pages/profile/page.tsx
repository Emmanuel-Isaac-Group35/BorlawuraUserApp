...
const styles = StyleSheet.create({
  ...
  modalBottomContent: { backgroundColor: '#ffffff', borderTopLeftRadius: 32, borderTopRightRadius: 32, padding: 24, paddingBottom: 40, maxHeight: '90%' },
  modalHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 },
  modalTitle: { fontSize: 20, fontFamily: typography.bold, color: '#0f172a' },
  closeButton: { width: 36, height: 36, backgroundColor: '#f1f5f9', borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  editAvatarSection: { alignItems: 'center', marginBottom: 24 },
  editAvatarWrapper: { position: 'relative' },
  editAvatar: { width: 100, height: 100, borderRadius: 34, backgroundColor: '#f1f5f9' },
  ...
  formGroup: { gap: 8 },
  formLabel: { fontSize: 14, fontFamily: typography.medium, color: '#64748b' },
  formInput: { padding: 16, backgroundColor: '#f8fafc', borderWidth: 1, borderColor: '#f1f5f9', borderRadius: 16, fontSize: 15, fontFamily: typography.medium, color: '#0f172a' },
  saveButton: { width: '100%', backgroundColor: '#10b981', paddingVertical: 16, borderRadius: 16, alignItems: 'center', shadowColor: '#10b981', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 8 },
  saveButtonText: { fontSize: 16, fontFamily: typography.bold, color: '#ffffff' },
});
